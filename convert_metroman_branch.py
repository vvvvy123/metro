#!/usr/bin/env python3
r"""
Converter for the MetroMan-format reports of networks that have BRANCH lines.

    C:\Users\admin\台北捷运线路信息.md  -> data/taipei.json    (prefix tp-)
    C:\Users\admin\香港地铁线路信息.md  -> data/hongkong.json  (prefix hk-)
    C:\Users\admin\天津地铁线路信息.md  -> data/tianjin.json   (prefix tj-)
...
CITIES = {
    "taipei": {
        "src": r"C:\Users\admin\台北捷运线路信息.md",
        "prefix": "tp",
    ...
    "hongkong": {
        "src": r"C:\Users\admin\香港地铁线路信息.md",
        "prefix": "hk",
    ...
    "tianjin": {
        "src": r"C:\Users\admin\天津地铁线路信息.md",
        "prefix": "tj",
...
def parse_overview(text):
    ...
    Rows are recognised by the `#rrggbb` colour cell rather than by the shape of
    the code, because 天津's `6Ⅱ` is not [0-9A-Za-z]. Every other table in these
    reports has 2, 3 or 4 cells, so the 8-cell + colour test is unambiguous.
    """
    out = {}
